...
- `/docs/DESIGN_GUIDE.md` - Colors, typography, components
- `/docs/DESKTOP_DESIGN_SPEC.md` - Desktop layouts
- `/docs/API_FRONTEND_MAPPING.md` - API integration guide
- `/docs/PAGE_COMPONENT_BREAKDOWN.md` - Component details
- `/docs/FRONTEND_ARCHITECTURE.md` - Technical architecture
- `/docs/FRONTEND_DESIGN_SUMMARY.md` - Executive summary
