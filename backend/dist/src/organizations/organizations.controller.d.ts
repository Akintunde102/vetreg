...
export declare class OrganizationsController {
    ...
    create(user: Vet, dto: CreateOrganizationDto): Promise<{
        name: string;
        id: string;
        email: string | null;
        phoneNumber: string;
    ...
    findOne(orgId: string, user: Vet): Promise<{
        memberships: ({
            vet: {
                id: string;
                email: string;
    ...
    update(orgId: string, user: Vet, dto: UpdateOrganizationDto): Promise<{
        name: string;
        id: string;
        email: string | null;
        phoneNumber: string;
